...
conCommandHandles["random-message"] = {
	"function": function( args ) {
		addConsoleText(coloredSpan( successColor, "Retrieving random message by " + coloredSpan(miscColor, args) + " in this conversation."));
	...
	"help-text": commandHandles["random-message"]["help-text"]
};

conCommandHandles["random-quote"] = {
	"function": function( args ) {
		addConsoleText(coloredSpan( successColor, "Getting random quote in " + coloredSpan(miscColor, args) + "." ));
		commandHandles["random-quote"]["function"](args);
	},
	"help-text": commandHandles["random-quote"]["help-text"]
};